...
export const meta: MetaFunction = ({ matches }) => {
  ...
  const routeMeta = [
    { title: "OCPS Cyber Challenge | Hack@UCF" },
    {
      name: "description",
      content:
        "Join the OCPS Cyber Challenge on January 30th. A cybersecurity competition for UCF students. Teams of 2, bring your charged laptops!",
    },
  ];
