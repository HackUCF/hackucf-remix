    ...
    <main className="min-h-screen p-8 bg-background text-foreground pt-28">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="mb-12 text-xl">
          As the need for cybersecurity experts across the nation grows, Hack@UCF
          has a space to further meet that need.
        </p>
        ...
        <section className="mb-16">
          ...
          <p className="mb-4">
            The lab is in UCF’s Engineering 1 building and serves as a learning hub,
            classroom, and the practice center for Hack@UCF. In November 2018,
            Lockheed Martin donated $1.5 million to UCF to help create the Cyber
            Innovation Lab. We are the only RSO on campus with access to a space
            like the Cyberlab. We hold office hours (most) weekdays during fall
            and spring so feel free to stop by. The Cyberlab is a space our members
            use to study, work on projects, hold meetings, and learn about cyber.
          </p>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="mb-4">
            The best place to park is Garage C{" "}
              ...
              </Link>{" "} (parking pass required).
            You can then enter though the main ENG 2 atrium or the ENG 1 entrance by Business Administration.{" "}
              <Link
